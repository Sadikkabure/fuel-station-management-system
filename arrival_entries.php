...
error_reporting(E_ALL); 
 ...
 $query ="select * from tankers";
  $tank= mysqli_query($connect,$query); 
...
$entry_id=mysqli_real_escape_string($connect, $_POST['entry_id']);
$station_id=mysqli_real_escape_string($connect, $_POST['station_id']);
$dateofentry=mysqli_real_escape_string($connect, $_POST['dateofentry']);
$tanke=mysqli_real_escape_string($connect, $_POST['tanker']);
$product=mysqli_real_escape_string($connect, $_POST['product']);
$quantitylifted=mysqli_real_escape_string($connect, $_POST['quantitylifted']);
$quantityreceived=mysqli_real_escape_string($connect, $_POST['quantityreceived']);
$shortage=mysqli_real_escape_string($connect, $_POST['shortage']);
$drivername=mysqli_real_escape_string($connect, $_POST['dname']);
$stats=mysqli_real_escape_string($connect, $_POST['stats']);
