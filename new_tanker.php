...
$query = "select * from employees where role='Driver'";
...
VALUES('$t_number',
  ...
  '$e_id')";
          ...
          if (mysqli_query($conn, $sql)) {
            ...
            $error = "ERROR: Review  the details  ";
          }
          mysqli_close($conn);
        }
        ...
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
          ...
          <h3 style="color:#F00;"> <?php if (isset($message)) echo $message;
                                    ?></h3>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="eid" required id="employeeid" readonly>
            </div>
          </div>
