...
$totalsales=mysqli_real_escape_string($connect, $_POST['totalsales']);
      ...
      calculate = function()
{
    ...
    document.getElementById('totalsales').value = parseInt(litres_sold)*parseInt(litres_price);
     ...
     document.getElementById('availablelitres').value = parseInt(available_litres)-parseInt(litres_sold);
...
?>
  ...
  <div class="form-group">
    ...
    <?php
 require "dbcon.php";
$getRecord= mysqli_query($connect,"select * from arrival_entries where station_id='$user' AND status = 'Active'");
