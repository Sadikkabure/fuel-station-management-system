      ...
      <section class="content">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered table-hover">
            ...
            <?php
            require __DIR__ . "/config/database.php";
            $getRecords_string = "select * from employees order by SN ASC ";
            ...
            if ($num_of_record > 0) {
              ...
              while ($record = mysqli_fetch_array($getRecord)) {
                ...
                echo "<td class=''>$record[role]</td>";
                echo "<td class=''>$record[salary]</td>";
                echo "<td class=''>$record[state_origin]</td>";



                echo '<td class=""><button class="btn-info "><a href="employee_more.php?employee_id=' . $record['employee_id'] . '">More</a></button></td>';
                echo '<td class=""><button class=" btn-success"><a href="employee_edit.php?employee_id=' . $record['employee_id'] . '">EDIT </a></button></td>';
                echo '<td class=""><button class="btn-danger "><a href="employee_delete.php?employee_id=' . $record['employee_id'] . '">DELETE</a></button></td>';
