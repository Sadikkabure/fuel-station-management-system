...
<div class="wrapper">
  <header class="main-header">
    <a href="ahome.php" class="logo">
      ...
      <span class="logo-lg"><b>TUKUR NIG LTD</b></span>
    </a>
...
<li>
 ...
 <?php
          $userInfo = mysqli_query($connect,"select * from employees where employee_id='$_GET[employee_id]'");
...
<input type="text" name="role" required class="form-control"value="<?php  echo  $user_information['role']  ?>"/>
</div>
...
<input type="text" name="salary" required class="form-control"value="<?php  echo  $user_information['salary']  ?>"/>
</div>
...
<input type="text" required class="form-control" name="address" value="<?php  echo  $user_information['address']  ?>"/>
</div>
