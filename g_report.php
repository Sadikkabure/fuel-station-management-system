    ...
    <div class="conainer-fluid">
      <div class="content-wrapper">
        <section class="content">
          <h2 align="center" style="color:black;"> Gas Sales Report</h2>


          <div style="position: relative; height: 550px; overflow: auto; display: block;">
            ...
            <table class="table table-bordered table-striped mb-0">
              ...
              <?php
              require __DIR__ . "/config/database.php";
              $getRecords_string = "select * from gas_sales order by SN ";
